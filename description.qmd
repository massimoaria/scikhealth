...
The indicators are designed to support reproducible and comparative research on Italian AHSCs. They are measured by `AHC` (the short name of the hospital/university institution) and `PY` (Publication Year)
...
***Indicators measured in the top 25th percentile of the Altmetric Score distribution\****:

|  |  |
|------------------------------------|------------------------------------|
| `altmetric_score` | Altmetric Score value (mean, min, and max) |
...
\* Mean, minimum, and maximum values were calculated for these indicators. This approach was adopted because a large proportion of publications either lack an Altmetric score or report zero activity across most altmetric sources, which would bias overall statistics.
...
| `perc_grant_internationalColl` | Proportion of grants with international collaboration. |
